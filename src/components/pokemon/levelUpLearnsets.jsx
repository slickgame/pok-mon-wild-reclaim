...
export const LEVEL_UP_LEARNSETS = {
  ...
  Pidgeot: {
    1: ['Tackle', 'Gust', 'Sand Attack', 'Quick Attack'],
    7: ['Feather Guard'],
    9: ['Wing Slap'],
    11: ['Whirlwind'],
    13: ['Air Cutter'],
  ...
  Raichu: {
    1: ['Thunder Punch', 'Quick Attack', 'Agility', 'Slam', 'Feint', 'Spark', 'Volt Tackle', 'Thunder Wave', 'Electro Ball', 'Discharge'],
  },
  ...
  Vileplume: {
    1: ['Mega Drain', 'Aromatherapy', 'Moonlight'],
    34: ['Petal Dance'],
    42: ['Sludge Bomb'],
    50: ['Giga Drain'],
  },
